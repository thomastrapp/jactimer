...
public:
  timeDisplay(uint seconds, uint numDigits, QWidget *parent = 0);
  ~timeDisplay();

private:
  static const int numberDigitsHour = 8;
  static const int numberDigitsMinute = 5;
  static const int numberDigitsSecond = 2;

  uint s;

public slots:
  void onNewTimerIndex(uint);
};

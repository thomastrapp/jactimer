...
dialogEvent::dialogEvent(QString message)
  : mb(QMessageBox::Information, tr("Timer"), message)
{
  mb.setModal(false);
}
...
{
  qDebug() << "dialogEvent going down";
}

void dialogEvent::start()
{
  mb.show();
}

void dialogEvent::stop()
{
  mb.hide();
}

...
#include "ui_aboutJACTDialog.h"

aboutJACTDialog::aboutJACTDialog(QWidget *parent)
  : QDialog(parent, Qt::Dialog),
    ui_dialog(new Ui::aboutJACTDialog),
    about(new aboutJACT(this))
{
  qDebug() << "aboutJACTDialog started";
  ui_dialog->setupUi(this);

  ui_dialog->vl_box->insertWidget(0, about);
}


aboutJACTDialog::~aboutJACTDialog()
{
  qDebug() << "aboutJACTDialog going down";
}
